	   ...
	   function(msg){
			...
			if(tabId){
				...
				_tabElement.omTabs('add',{
		            title : text, 
		            tabId :'menu'+menuId,
		            content : "<iframe id='"+menuId+"' src='"+url+"' height='"+_ifh+"' width='100%' frameBorder='no'></iframe>",
		            closable : true
		        });
			}
...
<div id="center-panel">
 	<div id="make-tab">
	    <ul id="tabUL"><li><a href="#indexP"><img class="homeicon" src="${img}/home.gif"/><span>&nbsp;我的主页</span></a></li></ul>
	   	<div id="indexP"><iframe id="indexF" width="100%" style="background:url(${img}/bj.jpg) 50px 0;border:none"></iframe></div> 
 	</div> 
</div>
