...
<link rel="stylesheet" type="text/css" href="<c:url value='/static/js/operamasks/2.0/css/v${v}.css'/>">
<link href="<c:url value="/static/css/css${v}/init.css"/>" rel="stylesheet" type="text/css" />
